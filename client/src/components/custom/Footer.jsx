...
import { Instagram, Twitter, Linkedin, Youtube, Sparkles } from "lucide-react";
            ...
            <div className="w-full max-w-7xl mx-auto px-5 sm:px-10 lg:px-20 relative z-10">
                <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-8 mb-16 sm:mb-20">
                    ...
                    <div className="w-full lg:w-[40%] flex flex-col items-center lg:items-start text-center lg:text-left">
                        <Link to="/" className="flex items-center gap-3 group cursor-pointer transition-transform duration-300 select-none mb-8 sm:mb-10">
                            <div className="w-10 h-10 bg-white text-black rounded-xl flex items-center justify-center font-black text-[18px] tracking-tight shadow-md group-hover:scale-105 transition-transform">
                                <Sparkles className="w-5 h-5 text-black" />
                            </div>
                            <div className="flex flex-col text-left">
                                <span className="font-urbanist font-black tracking-[0.06em] text-white text-[22px] sm:text-[26px] leading-tight">
                                    TRIP<span className="text-gray-400 font-light ml-1">MIND</span>
                                </span>
                                <span className="text-[8px] sm:text-[9px] font-bold tracking-[0.28em] text-gray-500 uppercase -mt-0.5">
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex items-center gap-3 opacity-50">
                        ...
                        <p className="text-[12px] font-inter text-gray-400 font-bold uppercase tracking-widest">
                            © {new Date().getFullYear()} Trip Mind
                        </p>
                    </div>
