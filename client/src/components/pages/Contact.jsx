                    ...
                    <div className="lg:col-span-5 space-y-6">
                        ...
                        <div className="p-6 sm:p-8 bg-[#0a0a0a] rounded-[24px] border border-white/10 hover:border-white/30 transition-all flex items-start gap-6 group">
                            ...
                            <div className="flex-1 pt-1">
                                ...
                                <a href="mailto:support@tripmind.ai" className="text-white font-inter font-bold text-[15px] hover:text-gray-300 transition-colors border-b border-white/20 pb-0.5">
                                    support@tripmind.ai
                                </a>
                            </div>
                        </div>
