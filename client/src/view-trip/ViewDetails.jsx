            ...
            <div className="bg-[#0a0a0a] border border-white/10 p-8 lg:p-10 rounded-sm space-y-10 shadow-2xl relative overflow-hidden group">
              ...
              <div className="space-y-4 relative z-10">
                ...
                {bookingStatus === 'approved' && (
                  <div className="w-full h-16 bg-emerald-500/10 border border-emerald-500/30 rounded-sm text-emerald-400 font-urbanist font-black text-[15px] uppercase tracking-widest flex items-center justify-center gap-3">
