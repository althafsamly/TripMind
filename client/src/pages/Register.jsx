                    ...
                    <div className="bg-[#0a0a0a] rounded-[20px] border border-white/10 p-4 shadow-2xl relative overflow-hidden">
                        ...
                        {success ? (
                            <div className="text-center py-4 animate-in fade-in zoom-in duration-500">
                                ...
                                <Link
                                    to="/login"
                                    className="inline-flex items-center justify-center h-11 px-6 font-inter font-bold text-[14px] rounded-[10px] transition-all bg-white hover:bg-gray-200 text-black"
                                >
                                    Login Now
                                </Link>
                            </div>
                            ...
                            <form className="space-y-3.5" autoComplete="off">
                                ...
                                <button
                                    onClick={handleClick}
                                    disabled={loading}
                                    className="w-full mt-1 h-11 font-urbanist text-[16px] font-bold rounded-[10px] transition-all flex items-center justify-center gap-2 group bg-white hover:bg-gray-200 text-black border border-white/20"
                                >
                                    {loading ? (
                                        <>
